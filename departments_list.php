...
?>
<?php
// departments_list.php - Page to list departments with CRUD links

// Include the database connection file
include 'db_connect.php';

// --- Fetch Departments Data ---
$sql = "SELECT DepartmentID, DepartmentName FROM Departments ORDER BY DepartmentID DESC"; // Order by ID for latest first
...
<body class="dark">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="mb-6 text-center">
            <a href="departments_add.php" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out shadow-lg">
        ...
        <div class="dark-card rounded-xl p-6">
             <h2 class="text-xl font-semibold mb-4 text-blue-300">All Departments</h2>
                    ...
                    <table class="min-w-full rounded-lg overflow-hidden dark-table">
                        <thead class="bg-gray-700">
                            <tr>
                                ...
                                <th class="py-3 px-4 text-left text-sm font-semibold text-gray-300">Department Name</th>
                        ...
                        <tbody class="text-gray-200">
                            <?php foreach ($departments as $department): ?>
                                <tr class="border-b border-gray-700 hover:bg-gray-700">
                                    <td class="py-3 px-4"><?php echo htmlspecialchars($department['DepartmentID']); ?></td>
                                    <td class="py-3 px-4"><?php echo htmlspecialchars($department['DepartmentName']); ?></td>
                                    <td class="py-3 px-4">
                                        <a href="departments_edit.php?id=<?php echo $department['DepartmentID']; ?>" class="action-link" title="Edit Department">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="departments_delete.php?id=<?php echo $department['DepartmentID']; ?>" class="action-link delete-link" title="Delete Department" onclick="return confirm('Are you sure you want to delete this department?');">
            ...
            <?php else: ?>
                <p class="text-gray-400">No departments found in the database.</p>
            <?php endif; ?>
        </div>
